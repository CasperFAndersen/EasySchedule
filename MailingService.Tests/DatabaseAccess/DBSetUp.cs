            ...
            using (SqlConnection conn = new DbConnectionADO().GetConnection())
            {
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = ""
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-10-25 17:00', 3, 1,  (select id from employee where name = 'Mikkel Paulsen')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-10-16 12:00', 7, 1,  (select id from employee where name = 'Mikkel Paulsen')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-05 08:00', 8, 1,  (select id from employee where name = 'Mikkel Paulsen')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-17 10:00', 5, 1,  (select id from employee where name = 'Mikkel Paulsen')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-05 14:00', 4, 1,  (select id from employee where name = 'Mikkel Paulsen')); " +
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-06 11:00', 7, 1, (select id from employee where name = 'Mikkel Paulsen')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-27 07:00', 8, 1,  (select id from employee where name = 'Stefan Krabbe')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-11-30 10:00', 8, 1, (select id from employee where name = 'Stefan Krabbe')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-10 17:00', 3, 1,  (select id from employee where name = 'Stefan Krabbe')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-03 14:00', 6, 1,  (select id from employee where name = 'Casper Froberg')); " +
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-17 13:00', 7, 1, (select id from employee where name = 'Casper Froberg')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-16 17:00', 3, 1,  (select id from employee where name = 'Casper Froberg')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-11-29 11:00', 5, 2, (select id from employee where name = 'Arne Ralston')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-08 09:00', 7, 2,  (select id from employee where name = 'Arne Ralston')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-11-29 09:00', 6, 2,  (select id from employee where name = 'Arne Ralston')); " +
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-24 11:00', 6, 2,  (select id from employee where name = 'Arne Ralston')); " +
                                      ...
                                      "insert into Shift(startTime, hours, scheduleId, employeeId)" + " values('2017-12-19 10:00', 9, 2,  (select id from employee where name = 'Tobias Andersen')); " +
